...
/**
 * In the previous pathway, you learned to use a NavHostController class to navigate
 * from one screen to another. With Compose, you can also change screens with simple
 * conditional statements by making use of runtime mutable states.
 * This is especially useful in small applications like the Reply app, where you only want
...
fun ReplyHomeScreen(
    ...
    if (navigationType == ReplyNavigationType.PermanentNavigationDrawer) {
    ...
    Box(modifier = modifier) {
        Row(modifier = modifier) {
            ...
            Column(
                ...
                if (contentType == ReplyContentType.ListAndDetail) {
                ...
                AnimatedVisibility(visible = navigationType == ReplyNavigationType.BottomNavigation) {
