...
class CupcakeScreenNavigationTest {
     ...
     * Therefore, you do not need to take any extra steps in the test methods to launch the app.
     */
    @get:Rule
    ...
    @Test
    fun cupcakeNavHost_clickNextOnFlavorScreen_navigatesToSelectPickupScreen() {
        navigateToPickupScreen()
        navController.assertCurrentRouteName(CupcakeScreen.Pickup.name)
    }

    @Test
    fun cupcakeNavHost_clickNextOnPickupScreen_navigatesToSelectSummaryScreen() {
