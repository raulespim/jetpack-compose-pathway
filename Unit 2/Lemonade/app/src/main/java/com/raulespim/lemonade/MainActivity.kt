package com.raulespim.lemonade
...
import com.raulespim.lemonade.ui.theme.LemonadeTheme
            ...
            when (currentStep) {
                ...
                2 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.lemon_squeeze_content_desc,
                        onImageClick = {
                            squeezeCount--
                            if (squeezeCount == 0) {
                                currentStep = 3
                ...
                3 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.lemon_drink_content_desc,
                        onImageClick = {
                            currentStep = 4
                        }
                    )
                ...
                4 -> {
                    LemonTextAndImage(
                        ...
                        contentDescriptionResourceId = R.string.lemon_restart_content_desc,
                        onImageClick = {
                            currentStep = 1
                        }
                    )
