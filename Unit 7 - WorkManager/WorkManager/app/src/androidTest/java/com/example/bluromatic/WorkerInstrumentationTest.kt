...
class WorkerInstrumentationTest {
    ...
    fun blurWorker_doWork_resultSuccessReturnsUri() {
        ...
        val expectedResultUri = "file:///data/user/0/com.example.bluromatic/files/blur_filter_outputs/blur-filter-output-"
        ...
        runBlocking {
            ...
            assertTrue(
                resultUri?.startsWith(expectedResultUri) ?: false
            )
        }
    }
